...
################################################################################
def main():
  usage = 'usage: %prog [options] <fasta_file> <seqs_bed_file> <tfr_file> <targets_file>'
  ...
  parser.add_option('--len', dest='seq_pool_len',
      default=1024, type='int',
      help='Sequence pooling length [Default: %default]')
  ...
  index_list = list(targets_df.index)
  
  seq_pool_len = options.seq_pool_len
